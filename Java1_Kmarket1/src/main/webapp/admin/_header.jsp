...
<html>
	<head>
        ...
        <script src="/Java1_Kmarket1/js/gnb.js"></script>
			...
			<header>
				<div>
		            ...
		            <p>
		                ...
		                <a href="/Java1_Kmarket1/index.do">HOME |</a>
		                <a href="/Java1_Kmarket1/member/logout.do">로그아웃 |</a>
		                <a href="/Java1_Kmarket1/cs/index.do">고객센터</a>
		            </p>
	            </div>
			</header>
			<main>
			    <aside>
			        <ul id="gnb">
			            ...
			            <li>
			                ...
			                <ol>
			                    <li class="lev"><a href="/Java1_Kmarket1/admin/cs/list.do?group=notice">공지사항</a></li>
			                    <li class="lev"><a href="/Java1_Kmarket1/admin/cs/list.do?group=faq">자주묻는질문</a></li>
			                    <li class="lev"><a href="/Java1_Kmarket1/admin/cs/list.do?group=qna">문의하기</a></li>
			                </ol>
			            </li>
			            	</c:when>
			            </c:choose>
